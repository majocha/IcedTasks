...
[<assembly: AssemblyTitleAttribute("IcedTasks.11")>]
[<assembly: AssemblyProductAttribute("IcedTasks.11")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "IcedTasks.11"
    let [<Literal>] AssemblyProduct = "IcedTasks.11"
